 ...
 */
@Configuration
@MapperScan(basePackages ="com.anonym.spring.mapper", sqlSessionTemplateRef  = "masterSqlSessionTemplate")
...
//		bean.setConfigLocation(new ClassPathResource("Configuration.xml"));
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/anonym/spring/mapper/*.xml"));
